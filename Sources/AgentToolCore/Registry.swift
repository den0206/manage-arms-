...
public struct Registry: Codable, Equatable, Sendable {
    ...
    /// 利用者が明示的に走査から除いたプロジェクトパス。自動除外（ホーム・ルート）とは別管理。
    /// 読み取りは `decodeIfPresent` なので、キーが無い旧 registry.json にも後方互換。
    ...
    public struct Entry: Codable, Equatable, Sendable {
        ...
        enum CodingKeys: String, CodingKey { case name, kind, repo, branch, subdir, sha, pinned, disabled }
    ...
    enum CodingKeys: String, CodingKey {
        case resources, repos, usage, projects, agents, excludedProjects
    }
